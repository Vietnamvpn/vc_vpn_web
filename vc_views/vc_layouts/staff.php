...
<head>
    ...
    <title><?php echo isset($pageTitle) ? htmlspecialchars($pageTitle) : 'Nhân viên - VC VPN Web'; ?></title>
    <link rel="stylesheet" href="/vc_assets/vc_css/staff.css">
</head>
<body class="staff-theme">
    ...
    <script src="/vc_assets/vc_js/staff.js"></script>
</body>
</html>